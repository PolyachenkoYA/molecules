...
def main():
    ...
    lmd_3 = xa0/k_exp * math.sqrt(8*Tmp_av / (math.pi*params['mu']))
        
    c_exp = xa0 / (k_exp*k_exp)
    ...
    if(draw_on_screen):
        print(c_th, c_exp, abs(c_th - c_exp)/min(c_th, c_exp))
        input()
    print(n0, Tmp_av, lmd_th0, lmd_th1, lmd_th2, lmd_1, lmd_2)
