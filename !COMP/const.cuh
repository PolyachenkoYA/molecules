...
#define BlockW 128 // for double set 256 in case of share memory amount
/*
 * max = 512
...
const int MaxN = int(pow(2,31)-1 + 0.5);

#define WrongCompMode CompModeID
#define VRcompMode (CompModeID+1)
#define LPcompMode (CompModeID+2)
#define RKcompMode (CompModeID+3)
#define AdVRcompMode (CompModeID+4)
...
#define CalcedT0Less0 (JustErrID-4)
#define FnumLess0 (JustErrID-3)
